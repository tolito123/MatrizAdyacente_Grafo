...
public class Grafo {
	...
	public void insertarArista(int v1, int v2, int Valor) 
				throws ArrayIndexOutOfBoundsException ,
				IllegalArgumentException{
		if(Valor == 0){
			throw new IllegalArgumentException();
		}
		 this.grafo[v1][v2] = Valor;		
		 this.grafo[v2][v1] = Valor;
	}
...
// ----- Métodos para Mostrar la lista de adyacencia de un vértice -----//
	...
	public boolean tieneAdyacentes(int v)
		...
		while(vActual < this.Nodos && !existeLista){
